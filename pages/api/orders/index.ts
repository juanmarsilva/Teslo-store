...
const createOrder = async (req: NextApiRequest, res: NextApiResponse<Data>) => {
    ...
    try {
       ...
       /* The code is calculating the subtotal of the order by iterating over each item in the
       `orderItems` array and multiplying the quantity of each item by its corresponding price. */
